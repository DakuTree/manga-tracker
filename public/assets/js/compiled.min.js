...
$(window),l=$("#category-nav").offset().top-$("#category-nav").find("> ul").height()-21,m=$("#list-nav"),n=$("table[data-list]");k.scroll(function(){d()});d();$("#update-notice").on("closed.bs.alert",function(){$.post(base_url+"ajax/hide_notice")})});$(function(){if("history"!==page)return!1;$("#history-pagination").pagination({currentPage:currentPagination,pages:totalPagination,displayedPages:10,hrefTextPrefix:"/user/history/",selectOnClick:!1,prevText:"&laquo;",nextText:"&raquo;"});$("#title-history-pagination").pagination({currentPage:currentPagination,pages:totalPagination,displayedPages:10,hrefTextPrefix:"/history/"+titleID+"/",selectOnClick:!1,prevText:"&laquo;",nextText:"&raquo;"})});$(function(){if("import_amr"!==page)return!1;var e="Manga-Fox;Batoto;Manga Here;MangaStream;Manga Panda;Kirei Cake;Dynasty Scans".split(";");$("#amr_import").change(function(){var d=this.files;if(d&&d[0])if(d=d[0],d.name.match(/\.(json|txt)$/))if(2097152<d.size)alert("ERROR: File too large ( < 2MB)!");else{var b=new FileReader;b.onload=function(a){a=a.target.result;var b;a:{try{JSON.parse(a)}catch(d){b=!1;break a}b=!0}if(b)if(a=JSON.parse(a),a.mangas){var h={};if(JSON.parse(a.mangas).every(function(a){return"mirror"in
