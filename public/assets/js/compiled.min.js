$(function(){$('[data-toggle="tooltip"]').tooltip({html:!0})});$(function(){function d(a,b){b="undefined"!==typeof b?b:!1;$("#import-status").text(a).show().delay(4E3).fadeOut(1E3).attr("style",b?"color: rgb(0, 230 ,0)":"color: rgb(230, 0 ,0)")}$(".tablesorter").tablesorter();$(".update-read").click(function(a){var b=this;a=$(this).closest("tr");var h=$(a).attr("data-id"),c=$(a).find(".current"),d=$(a).find(".latest");$.post(base_url+"ajax/update_tracker_inline",{id:h,chapter:d.attr("data-chapter")},function(a){$(b).hide();$(c).attr("href",$(d).attr("href")).text($(d).text())})});
