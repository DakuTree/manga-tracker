$(function(){$('[data-toggle="tooltip"]').tooltip({html:!0})});$(function(){function d(a,e){e="undefined"!==typeof e?e:!1;$("#import-status").text(a).show().delay(4E3).fadeOut(1E3).attr("style",e?"color: rgb(0, 230 ,0)":"color: rgb(230, 0 ,0)")}function g(){l.scrollTop()>=n?(m.css("margin-top","97px"),k.addClass("fixed-header"),k.css("width",$("#list-nav").parent().width()+"px")):(m.css("margin-top","5px"),k.removeClass("fixed-header"),k.css("width","initial"))}if("dashboard"!==page)return!1;$(".tablesorter").tablesorter();$(".tracker-table").find("> tbody > tr > td:nth-of-type(1)").click(function(a){$(a.target).is("input")||
...
":"+c+":"+d);0>--f&&(clearInterval(h),setTimeout(function(){$("link[rel*='icon']").attr("href",base_url+"favicon.production.updated.ico")},6E4))},1E3);var l=$(window),n=$("#category-nav").offset().top-$("#category-nav > ul").height()-21,k=$("#list-nav"),m=$("table[data-list]");l.scroll(function(){g()});g()});$(function(){if("login"!==page)return!1;$(".button-checkbox").each(function(){function d(){var d=c.is(":checked");b.data("state",d?"on":"off");b.find(".state-icon").removeClass().addClass("state-icon "+h[b.data("state")].icon);d?b.removeClass("btn-default").addClass("btn-"+f+" active"):b.removeClass("btn-"+f+" active").addClass("btn-default")}var g=$(this),b=g.find("button"),c=g.find("input:checkbox"),f=b.data("color"),h={on:{icon:"glyphicon glyphicon-check"},off:{icon:"glyphicon glyphicon-unchecked"}};
