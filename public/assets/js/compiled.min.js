$(function(){$('[data-toggle="tooltip"]').tooltip({html:!0})});$(function(){function d(a,b){b="undefined"!==typeof b?b:!1;$("#import-status").text(a).show().delay(4E3).fadeOut(1E3).attr("style",b?"color: rgb(0, 230 ,0)":"color: rgb(230, 0 ,0)")}$(".tablesorter").tablesorter({sortList:[[0,0],[1,0]]});$(".update-read").click(function(a){var b=this;a=$(this).closest("tr");var h=$(a).attr("data-id"),c=$(a).find(".current"),d=$(a).find(".latest");$.post(base_url+"ajax/update_tracker_inline",{id:h,chapter:d.attr("data-chapter")},function(a){$(b).hide();$(c).attr("href",
$(d).attr("href")).text($(d).text())})});$(".tracker-table").find("> tbody > tr > td:nth-of-type(1)").click(function(a){$(a.target).is("input")||(a=$(this).find("> input[type=checkbox]"),$(a).prop("checked",!a.prop("checked")))});$("#delete_selected").click(function(a){a.preventDefault();a=$(".tracker-table:visible").find("tr:has(td input[type=checkbox]:checked)");if(0<a.length){var b=[];$(a).each(function(){b.push($(this).attr("data-id"))});a=new FormData;a.append("json",JSON.stringify(b));$.ajax({type:"POST",
url:"./ajax/delete_inline",data:a,success:function(){location.reload()},error:function(a,b,c){},contentType:!1,processData:!1})}});$("#file_import").change(function(){var a=this.files;if(a&&a[0])if(a=a[0],a.name.match(/\.json$/))if(2097152<a.size)d("ERROR: File too large ( < 2MB)!");else{var b=new FileReader;b.onload=function(a){a=a.target.result;var b;a:{try{JSON.parse(a)}catch(c){b=!1;break a}b=!0}b?(b=new FormData,b.append("json",a),$.ajax({type:"POST",url:"./import_list",data:b,success:function(){d("Upload was a success! Reloading page.",
!0);setTimeout(function(){location.reload()},2500)},error:function(a,b,c){d("ERROR: Upload failed! - "+a.status)},contentType:!1,processData:!1})):d("ERROR: File isn't valid JSON!")};b.readAsText(a)}else d("ERROR: Only .json is supported!")});$(".more-info").click(function(a){a.preventDefault();$(this).find("+ .tags").toggle();"More info"==$(this).text()?$(this).text("Hide info"):$(this).text("More info")});$(".edit-tags").click(function(a){a.preventDefault();$(this).parent().find(".tag-edit").toggleClass("hidden")});
$(".tag-edit input").on("keypress",function(){13===event.which&&$(this).closest(".tag-edit").find("[type=button]").click()});$(".tag-edit [type=button]").click(function(){var a=this,b=$(this).closest(".tag-edit").find("input").val().trim().replace(/,,/g,","),c=$(this).closest("tr").attr("data-id");if(/^[a-z0-9,\-_]{0,255}$/.test(b)){var d=b.split(",");-1===$.inArray("none",d)?(b=new FormData,b.append("id",c),b.append("tag_string",d.join(",")),$.ajax({type:"POST",url:"./ajax/tag/update",data:b,success:function(){$(a).closest(".tags").find(".tag-list").text(d.join(",")||
...
$(this).find(":selected");if(a.is("[value]")){var b=$(".tracker-table:visible").find("tr:has(td input[type=checkbox]:checked)");if(0<b.length){var c={id_list:[],category:a.attr("value")};$(b).each(function(){c.id_list.push($(this).attr("data-id"))});a=new FormData;a.append("json",JSON.stringify(c));$.ajax({type:"POST",url:"./ajax/set_category",data:a,success:function(){location.reload()},error:function(a,b,c){},contentType:!1,processData:!1})}}});if(use_live_countdown_timer)var f=$("#update-timer"),
c=f.text().split(":"),e=parseInt(3600*c[0],10)+parseInt(60*c[1],10)+parseInt(c[2],10),g=setInterval(function(){var a=parseInt(e/60/60,10).toString(),b=parseInt(e/60%60,10).toString(),c=parseInt(e%60,10).toString();1==a.length&&(a="0"+a);1==b.length&&(b="0"+b);1==c.length&&(c="0"+c);f.text(a+":"+b+":"+c);0>--e&&clearInterval(g)},1E3)});$(function(){$(".button-checkbox").each(function(){function d(){var b=e.is(":checked");c.data("state",b?"on":"off");c.find(".state-icon").removeClass().addClass("state-icon "+a[c.data("state")].icon);b?c.removeClass("btn-default").addClass("btn-"+g+" active"):c.removeClass("btn-"+g+" active").addClass("btn-default")}var f=$(this),c=f.find("button"),e=f.find("input:checkbox"),g=c.data("color"),a={on:{icon:"glyphicon glyphicon-check"},off:{icon:"glyphicon glyphicon-unchecked"}};c.on("click",function(){e.prop("checked",
