$(function(){$('[data-toggle="tooltip"]').tooltip({html:!0});var c=$("#update-timer"),a=c.text().split(":"),b=parseInt(3600*a[0],10)+parseInt(60*a[1],10)+parseInt(a[2],10),e=setInterval(function(){var a=parseInt(b/60/60,10).toString(),d=parseInt(b/60%60,10).toString(),g=parseInt(b%60,10).toString();1==a.length&&(a="0"+a);1==d.length&&(d="0"+d);1==g.length&&(g="0"+g);c.text(a+":"+d+":"+g);0>--b&&clearInterval(e)},1E3)});$(function(){function c(a,b){b="undefined"!==typeof b?b:!1;$("#import-status").text(a).show().delay(4E3).fadeOut(1E3).attr("style",b?"color: rgb(0, 230 ,0)":"color: rgb(230, 0 ,0)")}$(".tablesorter").tablesorter({sortList:[[0,0],[1,0]]});$(".update-read").click(function(a){var b=this;a=$(this).closest("tr");var e=$(a).attr("data-id"),f=$(a).find(".current"),d=$(a).find(".latest");$.post(base_url+"ajax/update_tracker_inline",{id:e,chapter:d.text()},function(a){$(b).hide();$(f).attr("href",$(d).attr("href")).text($(d).text())})});
