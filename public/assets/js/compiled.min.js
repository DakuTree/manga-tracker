...
function(){$.post(base_url+"ajax/hide_notice")});$("#category-nav").find("> .nav > li > a").click(function(a){a.preventDefault();$(this).closest("ul").find("> .active").removeClass("active");$(this).parent().addClass("active");$(".tracker-table:visible").hide();a=$(this).attr("data-list");a=$('.tracker-table[data-list="'+a+'"]');a.show();a.has(".odd, .even").length||a.trigger("update",[!0]);$("html, body").animate({scrollTop:0},"slow")});(function(){function a(){b.scrollTop()>=d?(e.css("margin-top",
"97px"),c.addClass("fixed-header"),c.css("width",$("#list-nav").parent().width()+"px")):(e.css("margin-top","5px"),c.removeClass("fixed-header"),c.css("width","initial"))}var b=$(window),c=$("#list-nav"),d=c.offset().top-c.find("> ul").height()-21,e=$("table[data-list]");b.scroll(function(){a()});a()})();(function(){$("#toggle-nav-options").click(function(a){a.preventDefault();a=$(this).find("> i");var b=$("#nav-options");a.toggleClass("down");a.hasClass("down")?b.hide().slideDown(500):b.show().slideUp(500)});
$(".list_sort").change(function(){var b=$(".tracker-table"),c=$("select[name=list_sort_type]").val(),d=$("select[name=list_sort_order]"),e=d.val();if("n/a"!==c){if("list_sort_type"===$(this).attr("name")){switch(c){case "unread_latest":e="desc";break;case "my_status":e="desc";break;case "latest":e="desc";break;default:e="asc"}d.val(e)}b.trigger("sorton",[a(c,e)])}});$(".tracker-table").bind("sortEnd",function(){var a=$("select[name=list_sort_type]"),b=$("select[name=list_sort_order]"),c=this.config.sortList.reduce(function(a,
b,c){a[b[0]]=b[1];return a},{}),d="n/a",e="asc";switch(Object.keys(c).join()){case "0,1":0===c[0]&&(d="unread",e=0===c[1]?"asc":"desc");break;case "0,3":0===c[0]&&(d="unread-latest",e=0===c[1]?"asc":"desc");break;case "1":d="alphabetical";e=0===c[1]?"asc":"desc";break;case "2":d="my_status";e=0===c[2]?"asc":"desc";break;case "3":d="latest",e=0===c[3]?"asc":"desc"}a.val(d);b.val(e)})})();if("undefined"!==typeof use_live_countdown_timer&&use_live_countdown_timer&&!/^\/list\//.test(location.pathname))var e=
$("#update-timer"),k=e.text().split(":"),l=parseInt(3600*k[0],10)+parseInt(60*k[1],10)+parseInt(k[2],10),m=setInterval(function(){var a=parseInt(l/60/60,10).toString(),b=parseInt(l/60%60,10).toString(),c=parseInt(l%60,10).toString();1===a.length&&(a="0"+a);1===b.length&&(b="0"+b);1===c.length&&(c="0"+c);e.text(a+":"+b+":"+c);0>--l&&(clearInterval(m),setTimeout(function(){$('link[rel*="icon"]').attr("href",base_url+"favicon.production.updated.ico")},6E4))},1E3);$(".update-read").click(function(a,c){var d=
$(this).closest("tr"),f=$(this).closest("table"),e=$(d).attr("data-id"),g=$(d).find(".current"),r=$(d).find(".latest");c&&c.isUserscript?(console.log("Userscript is updating table..."),c.isLatest?b(f,d):(e=g.parent(),e.attr("data-updated-at",(new Date).toISOString().replace(/^([0-9]+-[0-9]+-[0-9]+)T([0-9]+:[0-9]+:[0-9]+)\.[0-9]+Z$/,"$1 $2")),f.trigger("updateCell",[e[0],!1,null]))):(e={id:e,chapter:r.attr("data-chapter")},$.post(base_url+"ajax/update_inline",e,function(){$(g).attr("href",$(r).attr("href")).text($(r).text());
b(f,d)}).fail(function(a,b,c){h(a,b,c)}))});$(".ignore-latest").click(function(){var a=$(this).closest("tr"),c=$(this).closest("table"),d=$(a).attr("data-id"),e=$(a).find(".current"),k=$(a).find(".latest");confirm("Ignore latest chapter?")&&(d={id:d,chapter:k.attr("data-chapter")},$.post(base_url+"ajax/ignore_inline",d,function(){$(e).parent().append($("<span/>",{"class":"hidden-chapter",title:"This latest chapter was marked as ignored.",text:$(k).text()}));b(c,a)}).fail(function(a,b,c){h(a,b,c)}))});
$("#mass-action").find("> select").change(function(){var a=!1,b=$(".tracker-table:visible").find("tr:has(td input[type=checkbox]:checked)"),c=b.length;if(0<c){var e={"id[]":$(b).map(function(){return parseInt($(this).attr("data-id"))}).toArray()};switch($(this).val()){case "delete":confirm("Are you sure you want to delete the "+c+" selected row(s)?")&&$.post(base_url+"ajax/delete_inline",e,function(){a=!0;location.reload()}).fail(function(a,b,c){h(a,b,c)});break;case "tag":confirm("Are you sure you want to edit the tags of "+
c+" selected row(s)?")&&(b=prompt("Tags: "),d(b,function(b){e.tag_string=b;$.post(base_url+"ajax/mass_tag_update",e,function(){a=!0;location.reload()}).fail(function(a,b,c){h(a,b,c)})}))}}else alert("No selected series found.");"n/a"===$(this).val()||a||(console.log("resetting value"),$(this).val("n/a"))});$(".set-mal-id").click(function(a){function b(a,b,c){c="0"!==c?c:"none";b.length?b.find("small").text(c):$("<span/>").append($("<small/>",{text:c})).prepend(" (").append(")").insertAfter(a)}function c(a,
b,c){c=c||function(){};$.post(base_url+"ajax/set_mal_id",{id:a,mal_id:b},function(){c()}).fail(function(a,b,c){h(a,b,c)})}var d=this;a.preventDefault();var f=this;a=$(this).attr("data-mal-id");if("title"!==$(this).attr("data-mal-type")||!$(this).attr("data-mal-id")||confirm("A MAL ID already exists for this series on our backend.\n Are you sure you want to override it?")){var e=prompt("MAL ID:",a);if(/^([0-9]+|none)?$/.test(e)){/^[0-9]+$/.test(e)&&(e=parseInt(e));a=$(this).closest("tr");var k=a.find("td:eq(1)"),
l=$(this).closest("table");a=a.attr("data-id");var n=$(k).find(".sprite-myanimelist-net").parent(),t=$(k).find(".sprite-myanimelist-net-none").parent(),m=$(this).find("+ span"),q=$.Deferred();""!==e&&"none"!==e&&0!==e?c(a,e,function(){$(t).remove();n.length?($(n).attr("href","https://myanimelist.net/manga/"+e),$(n).find(".sprite-myanimelist-net").attr("title",e)):$($("<a/>",{href:"https://myanimelist.net/manga/"+e,"class":"mal-link"}).append($("<i/>",{"class":"sprite-site sprite-myanimelist-net",
title:e}))).prepend(" ").insertAfter(k.find(".sprite-site"));b($(f),m,e);q.resolve()}):"none"===e||0===e?c(a,"0",function(){n.remove();t.remove();$($("<a/>",{"class":"mal-link"}).append($("<i/>",{"class":"sprite-site sprite-myanimelist-net-none",title:e}))).prepend(" ").insertAfter(k.find(".sprite-site"));b($(f),m,"none");q.resolve()}):c(a,null,function(){n.remove();t.remove();m.remove();q.resolve()});q.done(function(){$(d).attr("data-mal-id",e);l.trigger("updateCell",[k[0],!1,null])})}else null!==
e&&alert("MAL ID can only contain numbers.")}});(function(){$(".edit-tags").click(function(a){a.preventDefault();var b=$(this).parent().find(".tag-edit");b.toggleClass("hidden");b.hasClass("hidden")||setTimeout(function(){var a=b.find("> input");a.focus();var c=a.val();a.val("");a.val(c)},1)});$(".tag-edit input").on("keypress",function(a){13===a.which&&$(this).closest(".tag-edit").find("[type=button]").click()});$(".tag-edit [type=button]").click(function(){var a=this,b=$(this).closest(".tag-edit").find("input"),
c=b.val().toString().trim().replace(/,,/g,","),e=$(this).closest("tr").attr("data-id"),k=$(this).closest("table"),l=$(this).closest("td");d(c,function(c){$.post(base_url+"ajax/tag_update",{id:e,tag_string:c},function(){$(b).val(c);var d=$(a).closest(".more-info").find(".tag-list");if(c){var e=c.split(",").map(function(a,b){return $("<i/>",{"class":"tag",text:a})});d.html(e)}else d.text("none");k.trigger("updateCell",[l[0],!1,null]);$(a).closest(".tag-edit").toggleClass("hidden")}).fail(function(a,
